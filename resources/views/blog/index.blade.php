                ...
                <div class="flex flex-wrap gap-3 items-center">
                    ...
                    <div class="relative flex-1 min-w-[200px]">
                        <input type="text" name="q" value="{{ $q }}"
                               ...
                               class="w-full pl-9 pr-4 py-2.5 text-sm rounded-xl border border-gray-200 bg-white focus:outline-none focus:border-accent transition">
                    ...
                    @if($categories->isNotEmpty())
                        <select name="category"
                                class="px-4 py-2.5 text-sm rounded-xl border border-gray-200 bg-white focus:outline-none focus:border-accent transition text-dark"
                    ...
                    <button type="submit"
                            class="px-5 py-2.5 text-sm font-bold rounded-xl bg-accent text-white hover:bg-accent/90 transition">
                        Cari
                    </button>
                </div>
            </form>
