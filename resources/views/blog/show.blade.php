            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-8">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 p-6">
                        ...
                        <div class="mb-5">
                            {{-- Category + buttons (sejajar) --}}
                            <div class="flex items-center justify-between gap-3 mb-3">
                                @if($blog->category)
                                    <span class="inline-block text-[10px] font-bold uppercase tracking-widest border border-accent/40 rounded-full px-3 py-0.5 text-accent">
                                        {{ $blog->category }}
                                    </span>
                                @else
                                    <span></span>
                                ...
                                <div class="flex items-center gap-2 shrink-0">
                                    @auth
                                        @if(auth()->user()->hasRole('super_admin'))
                                            <a href="/admin/blogs/{{ $blog->id }}/edit"
                                               class="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-xl border border-gray-200 bg-white hover:border-gray-300 transition text-dark">
                                    ...
                                    <a href="{{ route('blog.index') }}"
                                       class="text-xs font-bold px-3 py-1.5 rounded-xl border border-gray-200 bg-white hover:border-gray-300 transition text-dark">
                                        Kembali
                                    </a>
                                </div>
                            </div>
