            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden flex flex-col group hover:shadow-md transition-shadow">
                ...
                <div class="p-4 flex-1 flex flex-col">
                    <div class="flex items-center justify-between mb-1">
                        <span class="text-[10px] font-bold uppercase tracking-widest text-gray-400">{{ $vendor->type }}</span>
                        <div class="flex items-center gap-1 text-xs font-medium" style="color: #f59e0b">
                    ...
                    <a href="{{ route('vendor.detail', $vendor->slug) }}" class="text-base font-bold mb-2 group-hover:text-accent transition" style="color: var(--dark-gray)">
                        {{ $vendor->name }}
                    </a>
